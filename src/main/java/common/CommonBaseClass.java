...
public class CommonBaseClass {
	...
	static{
		  ...
		  Date date = new Date();
		  dir = new File(System.getProperty("user.dir") + "//Report");
	...
	public static  void Creation() {
		...
		String extentReportFile = dir+"//extentReport.html";
		//String extentReportFile = new File(System.getProperty("user.dir")) + "//src//extent.html";
	...
	public static  void UpdateResult(Boolean result,String message) {
		
		if(result.equals(true))
			test.log(Status.PASS, "Passed-----"+message);
		else
